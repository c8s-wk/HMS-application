...
public class AdministratorMenu {
    ...
    // Assign the logged-in administrator
    public static void setAdministrator(Administrator administrator, List<User> hospitalStaff, List<Appointment> appointmentList, List<Medicine> medicineInventory) {
        admin = administrator;
        staff = hospitalStaff;
